...
- Quick-menu: floating 118px card, `rgba(36,32,29,0.92)` + blur, border = band hue @53%, 7px radius; two 17px mini-slider rows (label 7px / value 7.5px mono).
